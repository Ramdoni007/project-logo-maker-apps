...
import com.coolapps.logomaker.adapter.ColorPickerAdapter;

public class TextPropertiesFragment extends BottomSheetDialogFragment implements SeekBar.OnSeekBarChangeListener {

    public TextPropertiesFragment() {
    }
